...
export const USEROQUERIES = "UserQueries";
export const HOTELMANAGEMENT = "HotelManagement";
export const LEAVEFEEDBACK = "LeaveFeedback";
export const INACTIVEHOTELS = "InactiveHotels";
export const USERORDERS = "UserOrders";
export const ACTIVEHOTELS = "ActiveHotels";
export const SUSPENDHOTELS = "SuspendHotels";
